...
var (
	ErrNotFound = apperror.New("GAME_NOT_FOUND", "game not found")
	ErrIDs      = apperror.New("GAME_INVALID_IDS", "provide 1-100 positive game ids")
	ErrInvalid  = apperror.New("GAME_INVALID", "invalid game: positive id and name of 1-100 characters required")
)
